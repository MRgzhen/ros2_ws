...
def generate_launch_description():
    pkg_gzbot_gazebo = get_package_share_directory('gzbot_gazebo')
    ros_gz_sim = get_package_share_directory('ros_gz_sim')

    world_file = os.path.join(pkg_gzbot_gazebo, 'worlds', 'sim_env.world')
    models_path = os.path.join(pkg_gzbot_gazebo, 'models')
